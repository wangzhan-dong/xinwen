      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="content-box">
            <div id="gavelIcon" className="text-8xl mb-8 opacity-80 select-none drop-shadow-xl shadow-red-500/50">🔨</div>
            <h2 className="text-4xl font-black mb-6 leading-tight">2026：监管落地，告别野蛮生长</h2>
            <div className="space-y-6">
              <div className="p-8 bg-white/5 rounded-3xl border-l-4 border-red-500 backdrop-blur-sm shadow-sm">
              ...
              <div className="p-8 bg-white/5 rounded-3xl border-l-4 border-sky-400 backdrop-blur-sm shadow-sm">
                ...
                <p className="text-slate-400 text-sm leading-relaxed">
                  划出炒作与实质确权的清晰界限。未来的叙事不是投机致富，而是虚拟资产与实物关联的金融融合(如向Shopify的桥接互通)。
                </p>
              </div>
            </div>
          </div>
          <div className="content-box">
            <div className="bg-white/5 p-10 rounded-[3rem] text-white shadow-2xl relative border-4 border-white/10 backdrop-blur-md">
              ...
              <h3 className="text-2xl font-bold mb-4 text-white">《中华人民共和国民法典》第一百二十七条</h3>
              <p className="text-slate-300 mb-8 leading-relaxed italic border-l-4 border-slate-500 pl-4 py-1">
              ...
              <p className="text-center text-[11px] text-slate-400 mt-6 tracking-widest uppercase font-bold">
